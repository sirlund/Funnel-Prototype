	...
	<div class="mobile-view">
		...
		<div class="inner-container">
			<div style="padding: 3rem 1.5rem 1.5rem; text-align: center;">
				<h1 style="font-size: 1.75rem; font-weight: 700; margin-bottom: 0.5rem; color: #262626;">
					¡Gracias, {answers.name || 'Usuario'}!
				</h1>
				<p style="color: #6a6a6a; font-size: 0.875rem; margin-bottom: 2rem;">
				...
				>
					...
					>
						...
						<h3 style="font-size: 1.125rem; font-weight: 700; color: #2e7d32; margin-bottom: 0.5rem;">
							¡Cotización completada!
						</h3>
						<p style="color: #43a047; font-size: 0.875rem;">
				...
				<div style="display: flex; flex-direction: column; gap: 0.75rem;">
					<button
						...
						class="btn-mobile"
						style="width: 100%; background: #e7e7e7; color: #6a6a6a;"
					>
						← Volver
					</button>
					<button on:click={startOver} class="btn-mobile {isSportFunnel ? 'btn-sport' : ''}" style="width: 100%;">
						Comenzar de nuevo
					</button>
				</div>
			</div>
